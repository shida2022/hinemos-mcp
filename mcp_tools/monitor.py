                ...
                "properties": {
                    "monitor_info": {
                        ...
                        "description": (
                            ...
                            "    \"timeout\": 5000\n"
                            "  },\n"
                            "  \"numericValueInfo\": [8つの閾値設定],\n"
                            "  \"predictionMethod\": \"POLYNOMIAL_1\",\n"
                            "  \"predictionAnalysysRange\": 60,\n"
                            "  \"predictionTarget\": 60,\n"
                            "  \"changeAnalysysRange\": 60,\n"
                            "  \"predictionApplication\": \"http_app\",\n"
                            "  \"changeApplication\": \"http_app\"\n"
                            "}\n\n"
                            "重要な必須パラメータ:\n"
                            "- httpCheckInfo.requestUrl: URLの指定\n"
                            "- numericValueInfo: 8要素必須（BASIC×4 + CHANGE×4）\n"
                            "- 予測機能パラメータ: 全て必須"
                        )
                    }
                },
                ...
                "properties": {
                    "monitor_info": {
                        ...
                        "description": (
                            ...
                            "}\n\n"
                            "重要な必須パラメータ:\n"
                            "- httpCheckInfo.requestUrl: URLの指定（urlではない）\n"
                            "- httpCheckInfo.timeout: タイムアウト値\n"
                            "- stringValueInfo: 文字列判定条件\n"
                            "- priorityChange系: 両方必須"
                        )
                    }
                },
                "required": ["monitor_info"]
                ...
                "properties": {
                    "monitor_info": {
                        ...
                        "description": (
                            "カスタム文字列監視情報。例:\n"
                            "{\n"
                            "  \"monitorId\": \"CUSTOM_STRING_001\",\n"
                            "  \"monitorName\": \"カスタム文字列監視\",\n"
                            "  \"description\": \"カスタム文字列監視の説明\",\n"
                            "  \"facilityId\": \"REGISTERED\",\n"
                            "  \"runInterval\": \"MIN_05\",\n"
                            "  \"validFlg\": true,\n"
                            "  \"monitorFlg\": true,\n"
                            ...
                            "- customCheckInfo.effectiveUser: specifyUser=trueの場合必須\n"
                            "- customCheckInfo.convertFlg: 0=変換なし, 1=差分値\n"
                            "- stringValueInfo: 文字列判定条件の配列\n"
                            "- stringValueInfo.orderNo: 順序番号（1から連番）\n"
                ...
                "properties": {
                    "monitor_info": {
                        ...
                        "description": (
                            ...
                            "  \"collectorFlg\": false,\n"
                            "  \"ownerRoleId\": \"ALL_USERS\",\n"
                            "  \"application\": \"performance_app\",\n"
                            "  \"itemName\": \"$[PERF_CPU_USAGE]\",\n"
                            "  \"measure\": \"%\",\n"
                            "  \"predictionFlg\": false,\n"
                            "  \"changeFlg\": false,\n"
                            "  \"perfCheckInfo\": {\n"
                            "    \"itemCode\": \"CPU0100_CPU_UTIL\",\n"
                            "    \"deviceDisplayName\": \"\",\n"
                            "    \"breakdownFlg\": false\n"
                            "  },\n"
                            "  \"numericValueInfo\": [\n"
                            "    {\"monitorNumericType\": \"CHANGE\", \"priority\": \"INFO\", \"thresholdLowerLimit\": -1.0, \"thresholdUpperLimit\": 1.0},\n"
                            "    {\"monitorNumericType\": \"CHANGE\", \"priority\": \"WARNING\", \"thresholdLowerLimit\": -2.0, \"thresholdUpperLimit\": 2.0},\n"
                            "    {\"monitorNumericType\": \"CHANGE\", \"priority\": \"CRITICAL\", \"thresholdLowerLimit\": 0.0, \"thresholdUpperLimit\": 0.0},\n"
                            "    {\"monitorNumericType\": \"CHANGE\", \"priority\": \"UNKNOWN\", \"thresholdLowerLimit\": 0.0, \"thresholdUpperLimit\": 0.0},\n"
                            "    {\"monitorNumericType\": \"BASIC\", \"priority\": \"INFO\", \"thresholdLowerLimit\": 0.0, \"thresholdUpperLimit\": 0.0},\n"
                            "    {\"monitorNumericType\": \"BASIC\", \"priority\": \"WARNING\", \"thresholdLowerLimit\": 0.0, \"thresholdUpperLimit\": 0.0},\n"
                            "    {\"monitorNumericType\": \"BASIC\", \"priority\": \"CRITICAL\", \"thresholdLowerLimit\": 0.0, \"thresholdUpperLimit\": 0.0},\n"
                            "    {\"monitorNumericType\": \"BASIC\", \"priority\": \"UNKNOWN\", \"thresholdLowerLimit\": 0.0, \"thresholdUpperLimit\": 0.0}\n"
                            "  ],\n"
                            "  \"predictionMethod\": \"POLYNOMIAL_1\",\n"
                            "  \"predictionAnalysysRange\": 60,\n"
                            "  \"predictionTarget\": 60,\n"
                            ...
                            "- monitorFlg: 必須（通常true）\n"
                            "- runInterval: 必須（MIN_01,MIN_05,MIN_10,MIN_30,MIN_60）\n"
                            "- perfCheckInfo.itemCode: 必須（CollectorItemCodeマスタの値）\n"
                            "- itemName: 国際化キー（例: $[PERF_CPU_USAGE]）\n"
                            "- numericValueInfo: 8要素必須（CHANGE×4 + BASIC×4の各優先度）\n"
                            "- predictionFlg,changeFlg: Boolean値\n"
                            "- 有効なitemCode例: CPU0100_CPU_UTIL, MEM0100_MEM_USAGE等"
                        )
                    }
                },
                "required": ["monitor_info"]
                ...
                "properties": {
                    "monitor_info": {
                        ...
                        "description": (
                            ...
                            "}\n\n"
                            "重要な必須パラメータ:\n"
                            "- snmpCheckInfo.convertFlg: \"NONE\" (必須)\n"
                            "- snmpCheckInfo.snmpOid: SNMP OID\n"
                            "- snmpVersion: \"TYPE_V1\", \"TYPE_V2\", \"TYPE_V3\"\n"
                            "- numericValueInfo: 8要素必須（BASIC×4 + CHANGE×4）"
                        )
                    }
                },
                ...
                "properties": {
                    "monitor_info": {
                        ...
                        "description": (
                            "SNMP文字列監視情報。例:\n"
                            "{\n"
                            "  \"monitorId\": \"SNMP_STRING_001\",\n"
                            "  \"monitorName\": \"SNMP文字列監視\",\n"
                            "  \"facilityId\": \"REGISTERED\",\n"
                            "  \"runInterval\": \"MIN_05\",\n"
                            "  \"validFlg\": true,\n"
                            "  \"monitorFlg\": true,\n"
                            ...
                            "重要な必須パラメータ:\n"
                            "- snmpCheckInfo.convertFlg: \"NONE\" (必須)\n"
                            "- stringValueInfo.message: 必須\n"
                            "- stringValueInfo.orderNo: 順序番号"
                        )
                    }
                },
                "required": ["monitor_info"]
                ...
                "properties": {
                    "monitor_info": {
                        ...
                        "description": (
                            ...
                            "    {\"monitorNumericType\": \"CHANGE\", \"priority\": \"CRITICAL\", \"message\": null, \"thresholdLowerLimit\": 0.0, \"thresholdUpperLimit\": 0.0},\n"
                            "    {\"monitorNumericType\": \"CHANGE\", \"priority\": \"UNKNOWN\", \"message\": null, \"thresholdLowerLimit\": 0.0, \"thresholdUpperLimit\": 0.0},\n"
                            "    {\"monitorNumericType\": \"BASIC\", \"priority\": \"INFO\", \"message\": null, \"thresholdLowerLimit\": 0.0, \"thresholdUpperLimit\": 0.0},\n"
                            "    {\"monitorNumericType\": \"BASIC\", \"priority\": \"WARNING\", \"message\": null, \"thresholdLowerLimit\": 0.0, \"thresholdUpperLimit\": 0.0},\n"
                            "    {\"monitorNumericType\": \"BASIC\", \"priority\": \"CRITICAL\", \"message\": null, \"thresholdLowerLimit\": 0.0, \"thresholdUpperLimit\": 0.0},\n"
                            "    {\"monitorNumericType\": \"BASIC\", \"priority\": \"UNKNOWN\", \"message\": null, \"thresholdLowerLimit\": 0.0, \"thresholdUpperLimit\": 0.0}\n"
                            "  ],\n"
                            "  \"predictionMethod\": \"POLYNOMIAL_1\",\n"
                            ...
                            "  \"predictionTarget\": 60,\n"
                            "  \"changeAnalysysRange\": 60,\n"
                            "  \"predictionApplication\": \"process_app\",\n"
                            "  \"changeApplication\": \"process_app\"\n"
                            "}\n\n"
                            "重要な必須パラメータ:\n"
                            "- runInterval: MIN_05等（必須）\n"
                            "- predictionMethod: \"POLYNOMIAL_1\" (必須)\n"
                            "- numericValueInfo: 8要素必須（CHANGE×4 + BASIC×4）\n"
                            "- truthValueInfo: プロセス状態の真偽値判定\n"
                            "- processCheckInfo: コマンドとパラメータ指定\n"
                            "- 予測・変化監視パラメータ: 全て必須"
                        )
                    }
                },
